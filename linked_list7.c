...
Node, Replace a node and Removes duplicate elements from a sorted list. 
*/

// AlternatingSplit does not work.
...
/*void AlternatingSplit(List* list)
{
    ...
    Node* curr2 = (list -> head) -> link;
    //Node* prev = NULL;
    List* list1 = create_list();
    List* list2 = create_list();
    while(curr1->link->link != NULL)
    {
        insert_beginning(list1, curr1 -> data);
        curr1 = (curr1 -> link) -> link;
    }
    disp_list(list1);
    while(curr2->link->link != NULL)
    {
        insert_beginning(list2, curr2 -> data);
