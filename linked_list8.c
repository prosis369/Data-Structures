/* Linked list: Insert at beginning, Delete element, Display elements, Insert at given position, Reverse a list, Add After
Node, Replace a node, Removes duplicate elements from a sorted list and AlternatingSplit 
*/
...
void AlternatingSplit(List* list)
{
    Node* curr1 = list -> head;
    Node* curr2 = curr1 -> link;
    //Node* prev = NULL;
    List* list1 = create_list();
    List* list2 = create_list();
    while(curr1->link != NULL && curr1->link->link != NULL)
    {
        insert_end(list1, curr1 -> data);
        curr1 = curr1 -> link -> link;
    }
    insert_end(list1, curr1 -> data);
    disp_list(list1);
    printf("\n");
    while(curr2->link != NULL && curr2->link->link != NULL)
    {
        insert_end(list2, curr2 -> data);
        curr2 = curr2 -> link -> link;
    }
    insert_end(list2, curr2 -> data);
    disp_list(list2);
}
